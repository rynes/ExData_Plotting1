...
par(mfrow = c(2, 2))
# upper left
plot(x, data.sub$Global_active_power, type="l", xlab="", ylab="Global Active Power")
# upper right
plot(x, data.sub$Voltage, type="l", xlab="datetime", ylab="Voltage")
# lower left
op = par(bg="white")
...
legend("topright", legend=c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty="solid", col=c("black", "red", "blue"), bty="n", cex=0.9)
par(op)
# lower right
plot(x, data.sub$Global_reactive_power, type="l", xlab="datetime", ylab="Global_Reactive_Power")
